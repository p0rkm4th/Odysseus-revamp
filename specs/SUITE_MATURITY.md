...
| Work / Projects / Tasks | Work Engine, Runs, Actions, `read_work` | IMPLEMENTED / LIVE_VERIFIED / PARTIAL | overview, attention, continuation and persistence tests, empty-state authenticated browser read with final answer and reload-safe delivery, project creation through natural-language chat with canonical readback/reload proof, task creation contract coverage | cross-suite remediation/task journeys and broader fresh-install coverage | Tier 1 active |
