...
import chatModule from './js/chat.js?v=20260831approvaldirect1';
...
import chatRenderer from './js/chatRenderer.js?v=20260831approvaldirect1';
...
//  document.getElementById('chat-form').addEventListener('submit', chatModule.handleChatSubmit);
  ...
  const telegramBtn = el('tool-telegram-btn'); if (telegramBtn) telegramBtn.addEventListener('click', openTelegram);
