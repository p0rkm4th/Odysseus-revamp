...
def test_owner_journey_corpus_has_required_black_box_scenarios():
    ...
    assert {"OWNER-ASSET-RAM-001", "OWNER-NETWORK-001", "OWNER-ASSET-FILTER-NO-MATCH-001", "OWNER-RECIPE-EMPTY-001", "OWNER-RECIPE-MUTATION-READBACK-001", "OWNER-RECIPE-SHOPPING-REQUIREMENTS-001", "OWNER-HOUSEHOLD-MUTATION-READBACK-001", "OWNER-MEMORY-EMPTY-001", "OWNER-WORK-EMPTY-001"} <= set(scenarios)
