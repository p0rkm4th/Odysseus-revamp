...
def apply_recipe_owner_transformations(draft: RecipeDraft, transformations: Any) -> RecipeDraft:
    """Compatibility entrypoint for the Recipe-owned transformation resolver."""
    from src.domain_resolvers.recipe import apply_owner_transformations
    return apply_owner_transformations(draft, transformations)
