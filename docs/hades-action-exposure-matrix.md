...
| Communications | `communications.read` | `overview` | yes | yes | yes | yes | no | application / canonical EmailAccount + Calendar stores | none | authenticated owner scope; secret-free; message bodies/provider mutations excluded |
