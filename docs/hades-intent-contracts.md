...
Memory, Work, Setup/Integration, Household, and richer Network reads remain
explicit gaps until an existing owner-scoped service/action can be referenced
without inventing a side registry. Their absence is surfaced as an unresolved
contract, never repaired with filesystem or shell access.
